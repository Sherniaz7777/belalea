  ...
  return (
    <div>
      ...
      <div className={styles.overlay} id="Sign-Up" onClick={clickDiv}>
        <div className={styles.auth2} id="test">
          <NavLink to={'/'}>
          ...
          <div >
            ...
            >
              ...
              >
                ...
                <br />
                <div
                  style={{ display: "flex", justifyContent: "space-between" ,width:"317px" }}
                >
                ...
                <Button type="primary" style={{width:"320px", marginTop:"13px"}} htmlType="submit">
                    {t("Submit")}
